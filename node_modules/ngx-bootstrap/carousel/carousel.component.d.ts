...
export declare class CarouselComponent implements AfterViewInit, OnDestroy {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<CarouselComponent, "carousel", never, { "noWrap": { "alias": "noWrap"; "required": false; }; "noPause": { "alias": "noPause"; "required": false; }; "showIndicators": { "alias": "showIndicators"; "required": false; }; "pauseOnFocus": { "alias": "pauseOnFocus"; "required": false; }; "indicatorsByChunk": { "alias": "indicatorsByChunk"; "required": false; }; "itemsPerSlide": { "alias": "itemsPerSlide"; "required": false; }; "singleSlideOffset": { "alias": "singleSlideOffset"; "required": false; }; "isAnimated": { "alias": "isAnimated"; "required": false; }; "activeSlide": { "alias": "activeSlide"; "required": false; }; "startFromIndex": { "alias": "startFromIndex"; "required": false; }; "interval": { "alias": "interval"; "required": false; }; }, { "activeSlideChange": "activeSlideChange"; "slideRangeChange": "slideRangeChange"; }, never, ["*"], false, never>;
}
